...
/* ==============================
   🧾 FORMATEOS
============================== */
$fecha = !empty($cobro['fecha'])
    ? date('d/m/Y H:i', strtotime($cobro['fecha']))
    : '-';
...
<div class="row">
    <div class="col-md-6">
        ...
        <p><strong>Comprobante:</strong> 
            <?= htmlspecialchars($cobro['numero_completo']) ?>
        </p>
    </div>
...
<table class="table table-sm">
    ...
    <tfoot>
        ...
        <?php 
        $diferencia = round($total - $totalReparto, 2);
        if ($diferencia != 0): 
        ?>
            <tr>
