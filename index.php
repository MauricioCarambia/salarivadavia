...
// Última noticia para el hero + siguientes 4 para la grilla (una sola consulta:
// el hero es el primer resultado, antes se traía dos veces por separado).
// LEFT(texto, 400) alcanza de sobra para los resúmenes (180/120 caracteres) sin
// transferir el cuerpo completo de cada artículo.
$stmt = $pdo->query("
    SELECT id, titulo, imagen, created_at, LEFT(texto, 400) AS texto
    FROM articulos
