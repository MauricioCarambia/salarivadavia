        ...
        <div class="col-md-6">
            <div class="card card-outline card-info">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered table-hover tabla-empleados">
                                ...
                                <tr class="<?= !$emp['activo'] ? 'table-danger' : '' ?>">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center flex-wrap">
                                            ...
                                            <!-- BOTONES -->
                                           <button class="btn btn-info btn-sm editar-rol-empleado rounded-circle"
    data-id="<?= $emp['Id'] ?>"
    data-rol="<?= $emp['rol_id'] ?>">
    ...
    <i class="fa fa-trash"></i>
        ...
        <div class="col-md-6">
            <div class="card card-outline card-info">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered table-hover tabla-roles">
                        <thead class="thead-dark">
                            <tr>
                                <th>Rol</th>
                                <th>Accesos</th>
                        ...
                        <tbody>
                            <?php foreach ($roles_con_accesos as $rol): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                          <button class="btn btn-info btn-sm editar-rol rounded-circle"
    data-id="<?= $rol['id'] ?>">
    <i class="fa fa-user-tag"></i>
</button>
...
$(document).on('change', '.toggle-activo', function () {
    ...
    Swal.fire({
        ...
        $.post('ajax/empleado_edit_toggle.php', { id, activo }, function(res){
...
$('#guardarRolEmpleado').click(function () {
    ...
    $.post('ajax/empleado_rol.php', { id, rol }, function(res){
...
$('.editar-rol').click(function () {
    ...
    $.post('ajax/rol_get.php', { id: id }, function(res){
...
$('.eliminar-empleado').click(function () {
    ...
    Swal.fire({
        ...
        $.post('ajax/empleado_delete.php', { id }, function(res){
...
$('.eliminar-rol').click(function () {
    ...
    Swal.fire({
        ...
        $.post('ajax/rol_delete.php', { id }, function(res){
...
$('#guardarPass').click(function () {
    ...
    Swal.fire({
        ...
        $.post('ajax/empleado_pass.php', { id, pass }, function(res){
